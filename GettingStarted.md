...
10.  Open the [SAP Integration Suite Tenant](https://url.sap/2712tu0) (hint: hold *Ctrl* while clicking the link to open it in a new tab).
...
14. In the **Actions** column, use the **“…”** menu to **Copy the iFlow**.
