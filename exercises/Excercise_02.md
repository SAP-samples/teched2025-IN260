...
Repeat step 4 for creating the identifiers for the IDOC payloads. In this case, enter the following values:
...
You should finallly see two Single Identifiers
